...
% The following command customizes the date in each cell.  If we check
% for \HCode, then we know that we are exporting using htlatex, and we
% can add some additional html markup.
...
% Similar to above, but this command is for the class number.
...
%  LocalWords:  LinkedList umaine csLogo calprintdate calprintclass
